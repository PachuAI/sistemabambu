            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('precio_base_l1') is-invalid @enderror" 
                               ...
                               value="{{ old('precio_base_l1', $producto->precio_base_l1) }}" 
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-select @error('marca_producto') is-invalid @enderror" 
                        ...
                        <option value="bambu" {{ old('marca_producto', $producto->marca_producto ?? 'bambu') == 'bambu' ? 'selected' : '' }}>BAMBU</option>
                        <option value="saphirus" {{ old('marca_producto', $producto->marca_producto ?? 'bambu') == 'saphirus' ? 'selected' : '' }}>Saphirus</option>
                    </select>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('es_combo') is-invalid @enderror" 
                        ...
                        <option value="0" {{ old('es_combo', $producto->es_combo) == 0 ? 'selected' : '' }}>Individual</option>
                        <option value="1" {{ old('es_combo', $producto->es_combo) == 1 ? 'selected' : '' }}>Combo (Sin descuento)</option>
                    </select>
                    @error('es_combo')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
