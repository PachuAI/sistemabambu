...
<div class="card shadow-sm">
    <div class="card-header bg-info text-white">
        <h5 class="mb-0">
            <i class="bi bi-geo-alt"></i> Editar Ciudad
        </h5>
    </div>
    <div class="card-body">
        <form action="{{ route('ciudades.update', $ciudad) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                           id="nombre" name="nombre" value="{{ old('nombre', $ciudad->nombre) }}" required>
                    @error('nombre')
                    ...
                    <select class="form-select @error('provincia_id') is-invalid @enderror" 
                        ...
                        @foreach($provincias as $provincia)
                            <option value="{{ $provincia->id }}" 
                                {{ old('provincia_id', $ciudad->provincia_id) == $provincia->id ? 'selected' : '' }}>
                                {{ $provincia->nombre }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control @error('latitud') is-invalid @enderror" 
                           ...
                           value="{{ old('latitud', $ciudad->latitud) }}" 
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control @error('longitud') is-invalid @enderror" 
                           ...
                           value="{{ old('longitud', $ciudad->longitud) }}" 
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-info text-white">
                    <i class="bi bi-save"></i> Actualizar Ciudad
                </button>
            </div>
        </form>
    </div>
