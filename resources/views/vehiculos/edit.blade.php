...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="bi bi-truck"></i> Editar Vehículo</h1>
                ...
                <form action="{{ route('vehiculos.update', $vehiculo) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                               id="nombre" name="nombre" value="{{ old('nombre', $vehiculo->nombre) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('capacidad_bultos') is-invalid @enderror" 
                               id="capacidad_bultos" name="capacidad_bultos" value="{{ old('capacidad_bultos', $vehiculo->capacidad_bultos) }}" 
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-warning">
                            <i class="bi bi-check"></i> Actualizar Vehículo
                        </button>
                    </div>
                </form>
            </div>
